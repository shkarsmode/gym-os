...
import glutes from "../assets/muscles/glutes.svg?raw";
import adductors from "../assets/muscles/adductors.svg?raw";
...
export const muscleIcons = {
    ...
    "Сідниці": glutes,
    "Внутрішня поверхня стегна": adductors,
    "Литки": calves,
    "Передпліччя": forearms,
    // "Все тіло" deliberately has no entry of its own — the whole-body silhouette IS
    // the right picture for it, and it falls back to `all`.
};
