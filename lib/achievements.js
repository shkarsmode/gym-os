...
function tenureUnlockDate(joinedAt, months) {
    if (!joinedAt) {
        return null;
    }
    ...
    return unlock <= new Date() ? unlock.toISOString().slice(0, 10) : null;
}
...
export const ACHIEVEMENTS = [
    ...
    },
    {
        ...
        icon: "calendar-clock",
        xp: 100,
        check: ({ joinedAt }) => tenureUnlockDate(joinedAt, 1)
    },
    {
        id: "tenure-6m",
        ...
        icon: "calendar-range",
        xp: 200,
        check: ({ joinedAt }) => tenureUnlockDate(joinedAt, 6)
    },
    {
        id: "tenure-1y",
        title: "Рік вислуги",
        ...
        icon: "cake",
        xp: 400,
        check: ({ joinedAt }) => tenureUnlockDate(joinedAt, 12)
    },
    {
        id: "tenure-2y",
        ...
        icon: "gem",
        xp: 800,
        check: ({ joinedAt }) => tenureUnlockDate(joinedAt, 24)
    },
    {
        id: "tenure-3y",
        ...
        icon: "crown",
        xp: 1200,
        check: ({ joinedAt }) => tenureUnlockDate(joinedAt, 36)
    }
];
